    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bot_btn1 != null) {
            bot_btn1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent timer = new Intent(Timer.this, MainActivity.class);
                    startActivity(timer);
                }
            });
        }
        if(bot_btn3 != null) {
            bot_btn3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent stopwatch = new Intent(Timer.this, StopwatchActivity.class);
        ...
        if(bot_btn4 != null) {
            bot_btn4.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent alarm = new Intent(Timer.this, Alarm.class);
                    startActivity(alarm);
                }
            });
        }
